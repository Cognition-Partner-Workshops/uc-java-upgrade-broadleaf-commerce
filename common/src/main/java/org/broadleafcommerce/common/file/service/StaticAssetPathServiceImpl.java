...
public class StaticAssetPathServiceImpl implements StaticAssetPathService {
     ...
     */
    /**
     * Returns true if the supplied URL is absolute (i.e. begins with a valid URL scheme such as
     * {@code http:}/{@code https:}). Mirrors the semantics of the velocity-tools
     * {@code ImportSupport.isAbsoluteUrl} that was dropped during the Jakarta migration.
     */
