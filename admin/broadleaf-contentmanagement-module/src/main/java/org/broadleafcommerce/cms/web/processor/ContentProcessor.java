 ...
 * </ul>
 */
// TODO(java21-migration): Thymeleaf 3 removed the DOM-based AbstractElementProcessor, org.thymeleaf.Arguments and
// org.thymeleaf.dom.Element. This processor now extends the event-based AbstractModelVariableModifierProcessor and reads
// attributes from IProcessableElementTag, evaluates expressions through ITemplateContext, and contributes model
// variables via IElementTagStructureHandler. The current HttpServletRequest is resolved from the BroadleafRequestContext
// instead of casting the Thymeleaf context to IWebContext.
public class ContentProcessor extends AbstractModelVariableModifierProcessor {
    ...
    @Override
    protected void modifyModelAttributes(final ITemplateContext context, IProcessableElementTag tag, IElementTagStructureHandler structureHandler) {
     ...
     * @param context Thymeleaf template context
     * @param tag element context that this Thymeleaf processor is being executed in
     * @return
     */
