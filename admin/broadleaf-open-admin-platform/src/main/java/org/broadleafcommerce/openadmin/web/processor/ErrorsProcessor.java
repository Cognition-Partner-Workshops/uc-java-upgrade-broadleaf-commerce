 ...
 */
// TODO(java21-migration): Thymeleaf 3 removed the DOM-based AbstractAttrProcessor and ProcessorResult; attribute
// processors now extend AbstractAttributeTagProcessor and contribute local variables via IElementTagStructureHandler.
// FieldUtils moved to org.thymeleaf.spring6.util and returns an IThymeleafBindStatus keyed off the ITemplateContext.
