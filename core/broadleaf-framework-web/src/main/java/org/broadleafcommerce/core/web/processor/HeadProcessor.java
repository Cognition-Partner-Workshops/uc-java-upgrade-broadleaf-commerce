 ...
 *
 */
// TODO(java21-migration): Thymeleaf 3 removed AbstractFragmentHandlingElementProcessor and the DOM model
// (org.thymeleaf.Arguments/org.thymeleaf.dom.Element/Node). This processor was already deprecated and its fragment
// inclusion was a no-op (it returned an empty fragment list). It now extends AbstractElementTagProcessor, contributes
// the pageTitle/additionalCss local variables via IElementTagStructureHandler, invokes the extension manager and removes
// the host element to preserve the original getRemoveHostNode()==true behavior.
@Deprecated
    ...
    protected void doProcess(ITemplateContext context, IProcessableElementTag tag, IElementTagStructureHandler structureHandler) {
        ...
        try {
            IStandardExpression expression = StandardExpressions.getExpressionParser(context.getConfiguration())
                    .parseExpression(context, pageTitle);
