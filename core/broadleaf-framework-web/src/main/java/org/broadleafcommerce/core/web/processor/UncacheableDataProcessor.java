 ...
 * @author bpolster
 */
// TODO(java21-migration): Thymeleaf 3 removed the DOM-based AbstractElementProcessor, org.thymeleaf.dom.Element/Macro/Node
// and ProcessorResult. This now extends the event-based AbstractElementTagProcessor; it reads template variables through
// ITemplateContext and replaces the host element with the generated <SCRIPT> markup via
...
public class UncacheableDataProcessor extends AbstractElementTagProcessor {
    ...
    public UncacheableDataProcessor() {
        super(TemplateMode.HTML, "blc", "uncacheabledata", true, null, false, 100);
    }
    ...
    protected void doProcess(ITemplateContext context, IProcessableElementTag tag, IElementTagStructureHandler structureHandler) {
        ...
        // Replace the host element with the generated markup (not further processable).
