...
public class UncacheableDataProcessor extends AbstractElementTagProcessor {
    ...
    public UncacheableDataProcessor() {
        super(TemplateMode.HTML, "blc", "uncacheabledata", true, null, false, 1000);
    }
    ...
    public String getUncacheableDataFunction(ITemplateContext context, IProcessableElementTag element) {
        String callback = element.getAttributeValue("callback");
        if (callback != null) {
            return callback;
        } else {
