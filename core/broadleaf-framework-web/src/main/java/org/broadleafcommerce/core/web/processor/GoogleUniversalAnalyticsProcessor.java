...
// and ProcessorResult. This now extends the event-based AbstractElementTagProcessor and replaces the host element with
// the generated markup via IElementTagStructureHandler#replaceWith.
