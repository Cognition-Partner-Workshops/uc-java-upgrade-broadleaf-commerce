...
public class GoogleUniversalAnalyticsProcessor extends AbstractElementTagProcessor {
    ...
    public GoogleUniversalAnalyticsProcessor() {
        super(TemplateMode.HTML, "blc", "google_universal_analytics", true, null, false, 1000);
    }
    ...
    @Override
    protected void doProcess(ITemplateContext arguments, IProcessableElementTag element, IElementTagStructureHandler structureHandler) {
        ...
        if (MapUtils.isNotEmpty(trackers)) {
            ...
            if (orderNumberExpression != null) {
                ...
                Expression expression = (Expression) expressionParser.parseExpression(arguments, orderNumberExpression);
                orderNumber = (String) expression.execute(arguments);
            }
