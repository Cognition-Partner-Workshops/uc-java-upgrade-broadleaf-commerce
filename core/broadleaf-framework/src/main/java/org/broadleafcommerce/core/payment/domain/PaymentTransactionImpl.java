...
public class PaymentTransactionImpl implements PaymentTransaction {
    ...
    // TODO(java21-migration): Hibernate 6 maps @Lob String to CLOB natively; the removed @Type(StringClobType) override is unnecessary.
    ...
    // TODO(java21-migration): Hibernate 6 removed @MapKeyType and @Type(StringClobType); the String key and @Lob String
    // value map to native types without the explicit overrides.
    @ElementCollection
