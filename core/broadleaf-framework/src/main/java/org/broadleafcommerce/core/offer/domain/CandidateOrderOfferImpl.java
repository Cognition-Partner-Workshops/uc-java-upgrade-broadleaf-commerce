...
public class CandidateOrderOfferImpl implements CandidateOrderOffer {
    ...
    @org.hibernate.annotations.Index(name="CANDIDATE_ORDER_INDEX", columnNames={"ORDER_ID"})
    protected Order order;

    @ManyToOne(targetEntity = OfferImpl.class, optional=false)
    @JoinColumn(name = "OFFER_ID")
    @org.hibernate.annotations.Index(name="CANDIDATE_ORDEROFFER_INDEX", columnNames={"OFFER_ID"})
