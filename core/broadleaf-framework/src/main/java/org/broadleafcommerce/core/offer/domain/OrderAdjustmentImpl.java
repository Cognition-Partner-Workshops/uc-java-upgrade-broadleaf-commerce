...
public class OrderAdjustmentImpl implements OrderAdjustment, CurrencyCodeIdentifiable {
    ...
    @org.hibernate.annotations.Index(name="ORDERADJUST_ORDER_INDEX", columnNames={"ORDER_ID"})
    @AdminPresentation(excluded = true)
    protected Order order;

    @ManyToOne(targetEntity = OfferImpl.class, optional=false)
    @JoinColumn(name = "OFFER_ID")
    @org.hibernate.annotations.Index(name="ORDERADJUST_OFFER_INDEX", columnNames={"OFFER_ID"})
